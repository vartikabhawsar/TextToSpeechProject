...
int main()
{
    ...
    {
        cout<<"******************************************************"<<endl;
        cout<<"| ENTER THE PASSWORD TO CONFIRM YOU ARE Vartika|"<<endl;
        cout<<"******************************************************"<<endl<<endl;
        string phrase = "ENTER THE PASSWORD TO CONFIRM YOU ARE Vartika";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
    ...
    //                 const char *charCommand = command.c_str();
    //                 system(charCommand);
    //                 ShellExecute(NULL,"open","vartika.jpeg",NULL, NULL, SW_NORMAL);
    //             }
